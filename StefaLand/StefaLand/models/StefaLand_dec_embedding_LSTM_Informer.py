"""
MFFormer with Informer-style temporal encoding.

Uses dual position encoding (learnable + sinusoidal) with multi-scale
temporal feature processing and adaptive fusion.
"""
...
from MFFormer.layers.advanced_encoders import InformerPositionalEncoding
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Informer-style temporal encoding
        self.positional_encoding = InformerPositionalEncoding(embed_dim, dropout=configs.dropout)
    ...
    def init_weights(self):
        ...
        # Initialize temporal encoding parameters (Informer-style uses its own initialization)
    ...
    def forward(self, batch_data_dict, is_mask=True):
        ...
        temporal_features = batch_data_dict.get('temporal_features', None)  # [batch_size, seq_len, 7]
        ...
        # Apply Informer-style temporal encoding with optional temporal features
